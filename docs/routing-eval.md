...
`locale/<lang>/dataset/*.intent` templates: they are how people actually talk, elliptical ("i feel like listening to the beatles"), slang ("shove on some death
...
---
[← Open-vocab routing](metadatarr-routing.md) · [Home](index.md) · [Hierarchical experiment →](hierarchical.md)
