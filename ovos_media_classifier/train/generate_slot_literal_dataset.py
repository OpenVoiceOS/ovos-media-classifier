...
Usage::
    ...
    python -m ovos_media_classifier.train.generate_slot_literal_dataset
    python -m ovos_media_classifier.train.generate_slot_literal_dataset \\
...
from ovos_media_classifier.train import get_output_dir, get_cache_dir
from ovos_media_classifier.train.generate_templates import get_templates_dir, load_templates
from ovos_media_classifier.train.sources import AUDIO_INTENTS, VIDEO_INTENTS, SCHEMA_COLUMNS
