...
Usage::
    ...
    python -m ovos_media_classifier.train.download_datasets
    python -m ovos_media_classifier.train.download_datasets --dry-run
    OVOS_MEDIA_CLASSIFIER_CACHE=/data/ocp python -m ovos_media_classifier.train.download_datasets
"""
...
from ovos_media_classifier.train import get_cache_dir, get_csv_cache_dir, get_hf_cache_dir
from ovos_media_classifier.train.sources import ALL_CSV_SOURCES as _CSV_SOURCES, HF_DATASETS as _HF_DATASETS
