...
Usage::
    ...
    python -m ovos_media_classifier.train.generate_slot_filled_dataset
    python -m ovos_media_classifier.train.generate_slot_filled_dataset \\
...
from ovos_media_classifier.train import get_cache_dir, get_output_dir
...
from ovos_media_classifier.train.generate_slot_literal_dataset import _classify
