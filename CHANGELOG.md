...
- chore: hygiene pass — lockfile, test extra, SPDX license, AGENTS.md [\#61](https://github.com/OpenVoiceOS/ovos-media-classifier/pull/61) ([JarbasAl](https://github.com/JarbasAl))

## [0.2.0a1](https://github.com/OpenVoiceOS/ovos-media-classifier/tree/0.2.0a1) (2026-09-02)

[Full Changelog](https://github.com/OpenVoiceOS/ovos-media-classifier/compare/0.1.0a1...0.2.0a1)

**Merged pull requests:**

- feat: export every backend from the top level, lazily [\#44](https://github.com/OpenVoiceOS/ovos-media-classifier/pull/44) ([JarbasAl](https://github.com/JarbasAl))
...
- chore: commit the pytest and coverage configuration [\#43](https://github.com/OpenVoiceOS/ovos-media-classifier/pull/43) ([JarbasAl](https://github.com/JarbasAl))

## [0.0.3a3](https://github.com/OpenVoiceOS/ovos-media-classifier/tree/0.0.3a3) (2026-07-17)

[Full Changelog](https://github.com/OpenVoiceOS/ovos-media-classifier/compare/0.0.3a2...0.0.3a3)

**Merged pull requests:**

- refactor: table-driven backend factory [\#41](https://github.com/OpenVoiceOS/ovos-media-classifier/pull/41) ([JarbasAl](https://github.com/JarbasAl))
...
- refactor: drop the unused label→axis maps from intents.py [\#39](https://github.com/OpenVoiceOS/ovos-media-classifier/pull/39) ([JarbasAl](https://github.com/JarbasAl))

## [0.0.2a1](https://github.com/OpenVoiceOS/ovos-media-classifier/tree/0.0.2a1) (2026-07-17)

[Full Changelog](https://github.com/OpenVoiceOS/ovos-media-classifier/compare/0.0.1a1...0.0.2a1)

**Merged pull requests:**

- fix: make the version readable without importing the package [\#49](https://github.com/OpenVoiceOS/ovos-media-classifier/pull/49) ([JarbasAl](https://github.com/JarbasAl))
