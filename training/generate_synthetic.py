...
Usage::
    ...
    python -m training.generate_synthetic --max-per-intent 2000 --output my_synthetic.csv
    python -m training.generate_synthetic --skip-hf --output synthetic_curated.csv
...
from training import get_hf_cache_dir, get_output_dir
from training.sources import AUDIO_INTENTS as _AUDIO_INTENTS_SRC, VIDEO_INTENTS as _VIDEO_INTENTS_SRC
