...
Usage::
    ...
    python -m training.generate_from_ocp_templates
    python -m training.generate_from_ocp_templates --n 30 --output out.csv
    python -m training.generate_from_ocp_templates \\
...
def generate_from_templates(
    ...
    curated_pools = load_ner_entity_pools(hf_cache)
    ...
    from training.sources import AUDIO_INTENTS as _AUDIO, VIDEO_INTENTS as _VIDEO
